...
# see http://cwestblog.com/2013/01/29/bash-git-ps1-branch-based-coloring/
...
Prompt="${IBlack}${Username}${Color_Off} ${PathShort}"
...
if type -t __git_ps1 > /dev/null 2>&1; then
  ...
  Prompt=$Prompt$Yellow'$(__git_ps1 " (%s)")'$Color_Off
fi
